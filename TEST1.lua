...
if game.PlaceId == 14433762945 then
    ...
    AutoFarm_Raids:addDropdown({
        ...
        list = {"Easy","Medium","Hard","Impossible","Nightmare"}, 
    ...
    spawn(function()
        while wait() do
            ...
            elseif SaveSettings["MaxDamageChallenge"]['Auto Farm'] and game:GetService("Workspace").Worlds:FindFirstChild("MaxDamageChallenge") then
                local MaxDamageChallenge = game:GetService("Workspace").Worlds:FindFirstChild("MaxDamageChallenge"):FindFirstChild(CheckMaxDamageChallenge(LocalPlayer.Character.HumanoidRootPart.CFrame)) or nil
                if MaxDamageChallenge and MaxDamageChallenge:FindFirstChild('MaxDamageChallengeChest') then
                    fireproximityprompt(game:GetService("Workspace").Worlds:FindFirstChild("MaxDamageChallenge"):FindFirstChild(CheckMaxDamageChallenge(LocalPlayer.Character.HumanoidRootPart.CFrame)).MaxDamageChallengeChest.HumanoidRootPart.ChestPrompt)
                elseif MaxDamageChallenge and not MaxDamageChallenge:FindFirstChild('MaxDamageChallengeChest') then
                    for i,v in pairs(game:GetService("Workspace").Worlds:FindFirstChild("MaxDamageChallenge").Enemies:GetChildren()) do
                        if SaveSettings["MaxDamageChallenge"]['Auto Farm'] and v:FindFirstChild("HumanoidRootPart") and v:GetAttribute("Health") > 0 and v:GetAttribute("Invulnerable") ~= true and CheckMaxDamageChallenge(v:GetModelCFrame()) == CheckMaxDamageChallenge(game.Players.LocalPlayer.Character.HumanoidRootPart) then
                            repeat wait()
                                if v ~= nil then
                                    Character.HumanoidRootPart:PivotTo(v:GetModelCFrame() * CFrame.new(0,40,5))
                                    table.foreach(CheckPet('GetPet'),function(a,b)
            ...
            elseif SaveSettings["Raids"]['Auto Farm Raid'] and not WaitRaidCooldown and game:GetService("Workspace").Worlds:FindFirstChild("Hub") then
                if GetRaids("Owner") ~= "Not Found" then
                    ...
                    local args = { [1] = workspace.Worlds.Hub.DungeonTemple:FindFirstChild("1").RaidRooms[OwnerRaidRooms], [2] = "Private", [3] = SaveSettings["Raids"]['Private Room'] }   
                    game:GetService("ReplicatedStorage").Remote.Raid.SetRaidSetting:FireServer(unpack(args))

                    local args = { [1] = workspace.Worlds.Hub.DungeonTemple:FindFirstChild("1").RaidRooms[OwnerRaidRooms], [2] = "HoverWorld", [3] = DateWorld[SaveSettings["Raids"]["Select Raids [World]"]].WorldName }
                    game:GetService("ReplicatedStorage").Remote.Raid.SetRaidSetting:FireServer(unpack(args))

                    local args = { [1] = workspace.Worlds.Hub.DungeonTemple:FindFirstChild("1").RaidRooms[OwnerRaidRooms], [2] = "TargetWorld", [3] = DateWorld[SaveSettings["Raids"]["Select Raids [World]"]].WorldName }
                    game:GetService("ReplicatedStorage").Remote.Raid.SetRaidSetting:FireServer(unpack(args))

                    local args = { [1] = workspace.Worlds.Hub.DungeonTemple:FindFirstChild("1").RaidRooms[OwnerRaidRooms], [2] = "HoverWorld", [3] = "None" }
                    game:GetService("ReplicatedStorage").Remote.Raid.SetRaidSetting:FireServer(unpack(args))
    
                    local args = { [1] = workspace.Worlds.Hub.DungeonTemple:FindFirstChild("1").RaidRooms[OwnerRaidRooms], [2] = "Difficulty", [3] = SaveSettings["Raids"]['Select Difficulty'] }
                    game:GetService("ReplicatedStorage").Remote.Raid.SetRaidSetting:FireServer(unpack(args))
    
                    local args = { [1] = workspace.Worlds.Hub.DungeonTemple:FindFirstChild("1").RaidRooms[OwnerRaidRooms] }
